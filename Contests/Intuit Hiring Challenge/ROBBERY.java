...
Format
Input
The only line contains 5 space separated integers denoting cap(capacity of Truck), valueOfA(cost of type A toy), valueOfB(cost of type B toy), weightOfA(weight of type A toy), weightOfB(weight of type B toy) respectively.
