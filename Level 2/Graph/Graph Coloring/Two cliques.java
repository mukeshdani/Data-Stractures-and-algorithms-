//Two cliques
//https://www.codingninjas.com/codestudio/problems/two-cliques_1214524?leftPanelTab=0
...
public class Solution {
    public static boolean DFS( int src , int level , boolean[][] adj , int[] vis){
        ...
        for(int nbr  = 0 ; nbr < adj.length ; nbr++){
            if(src!=nbr &&adj[src][nbr] == false && DFS(nbr , 1 - level , adj , vis) == false )return false ;
        }
        return true;
    }
